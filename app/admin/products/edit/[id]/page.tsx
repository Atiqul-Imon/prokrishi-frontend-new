          ...
          <div className="space-y-6">
            <div>
              ...
              <label className="block cursor-pointer">
                ...
                {primaryImagePreview ? (
                  ...
                  <div className="relative inline-block">
                    <img src={existingPrimaryImage} alt="Current" className="w-40 h-40 object-cover rounded-xl border-2 border-slate-200 shadow-sm" />
                    <button
                      type="button"
            ...
            <div>
              ...
              {existingGallery.length > 0 && (
                <div className="mb-4">
                  <p className="text-xs font-medium text-slate-600 mb-3">Current Gallery Images</p>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {existingGallery.map((img, index) => (
                      <div key={index} className="relative group">
                        <img src={img} alt={`Gallery ${index + 1}`} className="w-full h-32 object-cover rounded-lg border-2 border-slate-200 shadow-sm" />
                        <button
                          type="button"
