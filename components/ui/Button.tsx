...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const sizes = {
      sm: "px-4 py-2.5 text-sm min-h-[44px] min-w-[44px]", // Mobile: 44x44px minimum
      md: "px-5 py-3 text-base min-h-[44px] min-w-[44px]", // Mobile: 44x44px minimum
      lg: "px-6 py-3.5 text-lg min-h-[48px] min-w-[48px]", // Mobile: 48x48px for primary actions
    };
